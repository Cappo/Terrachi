...
/* Math Stuffs for Jump Physics
 ...
 Solving For: gravity, jumpVelocity
    ...
    Solving For Gravity:
        // We can use this kinematic equation to solve for gravity:
            deltaMovement = velocityInitial * time + (acceleration*(time^2) / 2)

       // If we replace this values with our own variables.. (we can leave out velocityInitial * time because at the apex of the jump initial velocity will be zero)
